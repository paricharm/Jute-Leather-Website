...
<header id="header" class="header d-flex align-items-center"
  style="position: sticky;top:0px;box-shadow:0 2px 5px 0px rgba(0, 0, 0, 0.4)">
  <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">

    <a href="index.php" style="width:70px">
      <!-- Uncomment the line below if you also wish to use an image logo -->
      <img src="assets/img/logo.png" alt="কৃষি সংস্কৃতি" style="box-shadow: 0 0 0 0 !important;">
    ...
    <nav id="navmenu" class="navmenu">
      <ul>
        ...
        <li><a href="Jute.php" style="color:#812317">জুট</a></li>
        <li><a href="leather.php" style="color:#812317">লেদার</a></li>
        <li><a href="product.php" style="color:#812317">প্রোডাক্টস</a></li>
        <li><a href="contact.php" style="color:#812317">কন্টাক্ট</a></li>
        <style>
          .dynamic-select {
            display: flex;
...
<li>
    ...
    `;
          ...
          document.querySelectorAll('[data-dynamic-select]').forEach(select => new DynamicLanSelect(select, {
            width: '180px',
            height: '35px',
            columns: 1,
            placeholder: 'Select an option',
          ...
          function loadDoc(value) {
            ...
            xhttp.open("GET", "language.php?language="+value,true);
            xhttp.send();
          }
        </script>
      </ul>
