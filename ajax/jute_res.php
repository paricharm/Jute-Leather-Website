...
<main class="main">
  ...
  <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
    <div class="container position-relative">
      <h1>আমাদের জুট পণ্যসমূহ:</h1>
      <p>আমরা মহিলাদের ব্যাগের জন্য আধুনিক এবং সৃজনশীল ডিজাইনে বিশেষজ্ঞ, তবে আমাদের দক্ষ কারিগর এবং পর্যাপ্ত কাঁচামাল আমাদেরকে গ্রাহকের চাহিদা পূরণের জন্য বিস্তৃত পরিসরের পণ্য উৎপাদন করতে সক্ষম করে। আমাদের পণ্যের মধ্যে রয়েছে প্রচারণামূলক ব্যাগ, অফিস ব্যাগ, কলেজ ব্যাগ, টোট ব্যাগ, শপিং ব্যাগ, হ্যান্ডব্যাগ, পার্স, ওয়ালেট, লাঞ্চ ব্যাগ এবং অফিস স্টেশনারি।
      </p>
      <nav class="breadcrumbs">
        <ol>
          <li><a href="index.php " style="color:white;">হোম</a></li>
          <li class="current">জুট </li>
        </ol>
      </nav>
    </div>
  </div><!-- পেজ শিরোনাম সমাপ্ত -->
    ...
    <div class="container">
      <div class="row gy-4 justify-content-between align-items-center">
        <div class="col-lg-6 order-lg-1 position-relative" data-aos="zoom-out">
          <img src="./assets/img/jute5.jpg" alt="Image" class="shadow-none" style="border-radius:0% !important;height:500px !important;width:100%;">
        </div>
        <div class="col-lg-5 order-lg-2" data-aos="fade-up" data-aos-delay="100">
          <h2 class="content-title mb-4">বাংলাদেশে জুটের অবস্থান</h2>
          <p class="mb-4">
            বাংলাদেশে জুট চাষের ইতিহাস এক হাজার বছরেরও বেশি পুরনো। প্রাচীনকাল থেকেই বাঙালি কৃষকরা পাট চাষ করে আসছেন। বাংলাদেশ থেকে সারা বিশ্বে যেসব পণ্য রপ্তানি হয়, তার মধ্যে পাট এবং পাটজাত পণ্য অন্যতম। রপ্তানির ক্ষেত্রে পাট বাংলাদেশের তৃতীয় বৃহত্তম রপ্তানি পণ্য।
            বাংলাদেশে সাধারণত তিন প্রকার পাট রয়েছে: স্থানীয়, তোষা এবং মেস্তা। স্থানীয় পাটের তন্তু সাদা, তোষা পাট লালচে, আর মেস্তা পাটের তন্তু তুলনামূলকভাবে মোটা হয়। প্রতিটি জাতই উচ্চমানের, এবং এমন উচ্চমানের পাট পৃথিবীর অন্য কোথাও উৎপাদিত হয় না। বেশিরভাগ পাট বৃহত্তর রংপুর, ফরিদপুর, যশোর এবং কুষ্টিয়া অঞ্চলে চাষ হয়।
            জাতিসংঘের খাদ্য ও কৃষি সংস্থার (FAO) মতে, পাট উৎপাদনে বাংলাদেশ বিশ্বের শীর্ষে অবস্থান করছে, যা বিশ্বব্যাপী মোট পাট উৎপাদনের ৫৮% উৎপাদন করে।
          </p>
        </div>
      </div>
  </section><!-- /অ্যাবাউট ৩ সেকশন -->
  ...
  <!-- অ্যাবাউট ৩ সেকশন -->
  <section id="about-3" class="about-3 section">
    <h2 class="content-title my-5 text-center">আপনি কেন আমাদের পাটজাত পণ্য ব্যবহার করবেন?</h2>

    <div class="container text-center">
      <img src="assets/img/juteWSYUOJP1.avif" alt="Image" class="shadow-none" style="border-radius:0% !important;height:500px !important;width:95%;">
    </div>
    <div class="container col-12 col-lg-12 col-md-12">
      <p class="mt-5 px-3 fs-5 text-justify">
        পরিবেশবান্ধব প্রাকৃতিক তন্তু এবং উপকরণের মধ্যে পাট অন্যতম সেরা। বিশ্বজুড়ে প্লাস্টিক এবং সিনথেটিক পণ্যের ওপর নির্ভরশীলতার কারণে পৃথিবী ধ্বংসের দ্বারপ্রান্তে। পাট এই সমস্যার একটি চমৎকার সমাধান হতে পারে।
        পাট একটি জৈব দ্রবণযোগ্য পণ্য হওয়ায় এটি সহজেই সময়ের সাথে পরিবেশের সাথে একীভূত হয়ে যায়। এর বিপরীতে, প্লাস্টিক বা সিনথেটিক ব্যাগ, যেগুলো রাসায়নিক ভিত্তিক, সহজে পচে না এবং স্বাস্থ্যের জন্য ক্ষতিকর হতে পারে। একটি প্লাস্টিকের ব্যাগ মাটিতে পচে যেতে ৪০০ বছরেরও বেশি সময় নেয়, যেখানে একটি পাটের ব্যাগ স্বাভাবিকভাবে পরিবেশের সাথে মিশে যায়। তাছাড়া, প্লাস্টিকের ব্যাগ সাধারণত একবারই ব্যবহার করা হয়, কিন্তু পাটের ব্যাগ হাজারবার পুনরায় ব্যবহার করা যায়। এর শক্তিশালী তন্তু ভারী জিনিস সহজে বহন করতে সক্ষম।
        পাটের ব্যাগ বায়ুপ্রবাহ নিশ্চিত করে, যা যেকোনো পণ্য পরিবহনে স্বাস্থ্যবিধি বজায় রাখে, বিশেষ করে খাদ্যপণ্যগুলোর তাজা অবস্থা বজায় রাখতে সাহায্য করে। অন্যদিকে, প্লাস্টিকের ব্যাগ বায়ুপ্রবাহ নিশ্চিত করতে পারে না, যার ফলে পণ্যের গুণগত মান এবং তাজা অবস্থা বজায় রাখা কঠিন হয়, যা স্বাস্থ্যের জন্য ক্ষতিকর হতে পারে।
        পাটের ব্যাগ এবং প্লাস্টিকের ব্যাগের প্রধান পার্থক্য হল পাট প্রাকৃতিক, আর প্লাস্টিক সিনথেটিক। এই কৃত্রিমতা আমাদের গ্রহে ক্রমবর্ধমান দূষণ সৃষ্টি করছে। মানুষের দৈনন্দিন জীবনে সচেতনতা এবং পরিবর্তন আনাই একমাত্র উপায়ে এই দূষণ থেকে পৃথিবীকে রক্ষা করা সম্ভব।
      </p>
    </div>
  </section><!-- /অ্যাবাউট ৩ সেকশন -->
  ...
  <section class="team-15 team section" id="team">
    ...
    <div class="container section-title" data-aos="fade-up">
      <h2>আমাদের সর্বশ্রেষ্ঠ পাটজাত পণ্য</h2>
    </div>
          ...
          ?>
            <div class="col-lg-3 col-md-6 mb-4">
              <div class="person" style="border:1px solid rgba(0,0,0,0.2)">
                <figure>
                  <img src="admin/<?= $row['img'] ?>" alt="Image" class="img-fluid" style="border-radius:0% !important;height:400px !important;width:400px !important;" class="shadow-none">
  ...
  <section id="services" class="services section">
    ...
    <!-- Section Title -->
    <div class="container section-title" data-aos="fade-up">
      <h2>যেসব দেশে বাংলাদেশ পাট ও পাটজাত পণ্য রপ্তানি করে</h2>
        ...
        <div class="row g-0">
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">ভারত</h3>
                <p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">জাপান</h3>
                <p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">ইউরোপীয় ইউনিয়ন (ইইউ) দেশসমূহ</h3>
                <p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">মধ্যপ্রাচ্যের দেশসমূহ</h3>
                <p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">আফ্রিকান দেশসমূহ</h3>
                <p>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="service-item">
              ...
              <div class="service-item-content">
                <h3 class="service-heading">এশিয়ার অন্যান্য দেশ</h3>
                <p>
